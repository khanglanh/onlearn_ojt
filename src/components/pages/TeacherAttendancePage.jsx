...
export default function TeacherAttendancePage() {
  ...
  if (loading) {
    return (
      <TeacherLayout>
        <div className="teacher-attendance loading-state">
  ...
  if (error) {
    return (
      <TeacherLayout>
        <div className="teacher-attendance error-state">
    ...
    <TeacherLayout>
      <div className="teacher-attendance">
        <div className="page-header">
          <h1>Điểm danh</h1>
          <p>Quản lý điểm danh học viên trong các lớp học</p>
        </div>
          ...
          {selectedClass ? (
            <div className="attendance-panel">
              ...
              <div className="coming-soon">
                <p>Chức năng điểm danh đang được phát triển...</p>
                <p className="hint">Bạn sẽ có thể điểm danh học viên theo từng buổi học tại đây.</p>
              </div>
            </div>
          ) : (
            <div className="empty-state">
              <p>Vui lòng chọn một lớp học để quản lý điểm danh</p>
            </div>
          )}
        </div>
      </div>
